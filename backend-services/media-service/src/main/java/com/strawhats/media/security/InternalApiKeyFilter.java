...
import com.strawhats.media.config.InternalApiProperties;
 ...
 * since the caller here is core-service itself (US-18 mediaId validation),
 * not an end user. Only applied to requests under /internal/** (see
...
public class InternalApiKeyFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        // No user principal for service-to-service calls - just let it through
        // as an authenticated (non-user) request so SecurityConfig's
        // authorizeHttpRequests rule for /internal/** is satisfied.
